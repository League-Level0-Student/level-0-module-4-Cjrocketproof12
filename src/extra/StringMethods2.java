...
public class StringMethods2 {
	public static void main(String[] args) {
		...
		String colked = "ORANGE JUICe";
		
		// 2. Print your String to the console in upper case.
		System.out.println(colked.toUpperCase());
		...
		System.out.println(colked.toLowerCase());
		
		
		
		// 4. Print the first 3 char's of your String
		//    HINT: .substring(start,end)
		System.out.println(colked.substring(0, 3));
		...
		System.out.println(colked.charAt(colked.length()-1));
